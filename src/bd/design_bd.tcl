...
# module references:
# button_single, custom_register, custom_register, custom_register, custom_register, custom_register, div_part_clk_control, fix_shift, myrom4bit, myrom4bit, myrom4bit, myrom4bit, myrom5bit, myslice, myslice, myslice, myslice, myslice, new_axi_m, reg3, reg3, reg4, reg4, reg62, shift_r2, switch_16_8, w1_combine, w2_combine
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:DIV40_32_TOP:1.0\
xilinx.com:user:MUL_TOP:1.0\
xilinx.com:user:axi_s_control:1.0\
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net div_part_clk_control_0_clk_out [get_bd_pins DIV40_32_TOP_0/clk] [get_bd_pins div_part_clk_control_0/clk_out] [get_bd_pins reg62_0/clk]
  ...
  connect_bd_net -net new_axi_m_0_read_data_valid [get_bd_pins custom_register_5/data_in] [get_bd_pins new_axi_m_0/read_data_valid] [get_bd_pins reg62_0/din]
