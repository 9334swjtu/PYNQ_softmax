...
# module references:
# custom_register, custom_register, custom_register, custom_register, custom_register, custom_register, custom_register, custom_register, custom_register, custom_register, fix_shift, myresigter, myresigter, myresigter, myrom4bit, myrom4bit, myrom4bit, myrom4bit, myrom5bit, new_axi_m
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set can_read_0 [ create_bd_port -dir I can_read_0 ]
  set can_write_0 [ create_bd_port -dir I can_write_0 ]
  ...
  # Create instance: custom_register_1, and set properties
  set block_name custom_register
  set block_cell_name custom_register_1
  if { [catch {set custom_register_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $custom_register_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: custom_register_2, and set properties
  set block_name custom_register
  set block_cell_name custom_register_2
  if { [catch {set custom_register_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $custom_register_2 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: custom_register_3, and set properties
  set block_name custom_register
  set block_cell_name custom_register_3
  if { [catch {set custom_register_3 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $custom_register_3 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: custom_register_8, and set properties
  set block_name custom_register
  set block_cell_name custom_register_8
  if { [catch {set custom_register_8 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $custom_register_8 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: custom_register_9, and set properties
  set block_name custom_register
  set block_cell_name custom_register_9
  if { [catch {set custom_register_9 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $custom_register_9 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: myresigter_0, and set properties
  set block_name myresigter
  set block_cell_name myresigter_0
  if { [catch {set myresigter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $myresigter_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: myresigter_1, and set properties
  set block_name myresigter
  set block_cell_name myresigter_1
  if { [catch {set myresigter_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $myresigter_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: myresigter_2, and set properties
  set block_name myresigter
  set block_cell_name myresigter_2
  if { [catch {set myresigter_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $myresigter_2 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  if { [catch {set new_axi_m_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
   ...
   CONFIG.C_M_TRANSACTIONS_NUM {1024} \
   CONFIG.R_BASEADDR {0x02000000} \
   CONFIG.W_BASEADDR {0x01000000} \
 ] $new_axi_m_0
  ...
  connect_bd_net -net clk_0_1 [get_bd_pins custom_register_0/clk] [get_bd_pins custom_register_1/clk] [get_bd_pins custom_register_2/clk] [get_bd_pins custom_register_3/clk] [get_bd_pins custom_register_4/clk] [get_bd_pins custom_register_5/clk] [get_bd_pins custom_register_6/clk] [get_bd_pins custom_register_7/clk] [get_bd_pins custom_register_8/clk] [get_bd_pins custom_register_9/clk] [get_bd_pins fix_shift_0/clk] [get_bd_pins mult_gen_0/CLK] [get_bd_pins mult_gen_1/CLK] [get_bd_pins mult_gen_2/CLK] [get_bd_pins mult_gen_3/CLK] [get_bd_pins myresigter_0/clk] [get_bd_pins myresigter_1/clk] [get_bd_pins myresigter_2/clk] [get_bd_pins myrom4bit_4/clk] [get_bd_pins myrom4bit_5/clk] [get_bd_pins myrom4bit_6/clk] [get_bd_pins myrom4bit_7/clk] [get_bd_pins myrom5bit_1/clk] [get_bd_pins new_axi_m_0/M_AXI_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net custom_register_0_data_out [get_bd_pins custom_register_0/data_out] [get_bd_pins custom_register_1/data_in]
  connect_bd_net -net custom_register_1_data_out [get_bd_pins custom_register_1/data_out] [get_bd_pins custom_register_2/data_in]
  connect_bd_net -net custom_register_2_data_out [get_bd_pins custom_register_2/data_out] [get_bd_pins custom_register_3/data_in]
  connect_bd_net -net custom_register_3_data_out [get_bd_pins custom_register_3/data_out] [get_bd_pins custom_register_4/data_in]
  connect_bd_net -net custom_register_5_data_out [get_bd_pins custom_register_5/data_out] [get_bd_pins custom_register_6/data_in]
  connect_bd_net -net custom_register_6_data_out [get_bd_pins custom_register_6/data_out] [get_bd_pins custom_register_7/data_in]
  connect_bd_net -net custom_register_7_data_out [get_bd_pins custom_register_7/data_out] [get_bd_pins custom_register_8/data_in]
  connect_bd_net -net custom_register_8_data_out [get_bd_pins custom_register_8/data_out] [get_bd_pins custom_register_9/data_in]
  connect_bd_net -net custom_register_9_data_out [get_bd_pins custom_register_9/data_out] [get_bd_pins new_axi_m_0/w_data]
  ...
  connect_bd_net -net m00_axi_init_axi_txn_0_1 [get_bd_ports m00_axi_init_axi_txn_0] [get_bd_pins new_axi_m_0/INIT_AXI_TXN] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net mult_gen_0_P [get_bd_pins mult_gen_0/P] [get_bd_pins myresigter_2/data_in]
  connect_bd_net -net mult_gen_1_P [get_bd_pins mult_gen_0/B] [get_bd_pins mult_gen_1/P]
  connect_bd_net -net mult_gen_2_P [get_bd_pins mult_gen_1/B] [get_bd_pins mult_gen_2/P]
  connect_bd_net -net mult_gen_3_P [get_bd_pins mult_gen_1/A] [get_bd_pins mult_gen_3/P]
  connect_bd_net -net myresigter_0_data_out [get_bd_pins mult_gen_0/A] [get_bd_pins myresigter_0/data_out]
  connect_bd_net -net myresigter_1_data_out [get_bd_pins myresigter_0/data_in] [get_bd_pins myresigter_1/data_out]
  connect_bd_net -net myrom4bit_4_cur_result [get_bd_pins mult_gen_3/A] [get_bd_pins myrom4bit_4/cur_result]
  connect_bd_net -net myrom4bit_5_cur_result [get_bd_pins mult_gen_3/B] [get_bd_pins myrom4bit_5/cur_result]
  connect_bd_net -net myrom4bit_6_cur_result [get_bd_pins mult_gen_2/A] [get_bd_pins myrom4bit_6/cur_result]
  connect_bd_net -net myrom4bit_7_cur_result [get_bd_pins mult_gen_2/B] [get_bd_pins myrom4bit_7/cur_result]
  connect_bd_net -net myrom5bit_1_cur_result [get_bd_pins myresigter_1/data_in] [get_bd_pins myrom5bit_1/cur_result]
  connect_bd_net -net new_axi_m_0_r_data [get_bd_pins fix_shift_0/input_data] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net new_axi_m_0_r_data1 [get_bd_pins custom_register_5/data_in] [get_bd_pins new_axi_m_0/r_data]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins custom_register_0/rst] [get_bd_pins custom_register_1/rst] [get_bd_pins custom_register_2/rst] [get_bd_pins custom_register_3/rst] [get_bd_pins custom_register_4/rst] [get_bd_pins custom_register_5/rst] [get_bd_pins custom_register_6/rst] [get_bd_pins custom_register_7/rst] [get_bd_pins custom_register_8/rst] [get_bd_pins custom_register_9/rst] [get_bd_pins fix_shift_0/rst] [get_bd_pins myresigter_0/rst_n] [get_bd_pins myresigter_1/rst_n] [get_bd_pins myresigter_2/rst_n] [get_bd_pins myrom4bit_4/rst_n] [get_bd_pins myrom4bit_5/rst_n] [get_bd_pins myrom4bit_6/rst_n] [get_bd_pins myrom4bit_7/rst_n] [get_bd_pins myrom5bit_1/rst_n] [get_bd_pins new_axi_m_0/M_AXI_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins new_axi_m_0/write_data_valid] [get_bd_pins xlconstant_0/dout]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces new_axi_m_0/M_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
